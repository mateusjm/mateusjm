...
<div align="center">
  <h1>Mateus Lucas</h1>
  <p><b>Desenvolvedor Full Stack</b> • TypeScript • React • Node.js</p>
  <p>Construo aplicações web modernas com foco em performance, organização de código e experiência do usuário.</p>
</div>
...
<ul>
  <li>
    ...
    <br/><b>Stack</b>: JavaScript • React • Node.js • MySQL • Docker • AWS
    <br/><b>Destaque</b>: geração/armazenamento de PDFs e arquitetura containerizada.
    <br/><a href="https://github.com/GoDo-Devs/priceasy" target="_blank">Repositório</a>
  </li>
  <br/>
  <li>
    <b>App Natura</b> — sistema de controle de estoque e vendas com dashboard interativo.
    <br/><b>Stack</b>: React • TypeScript • Node.js • NestJS • MySQL • Material UI
    <br/><b>Destaque</b>: visão operacional e acompanhamento de resultados em tempo real.
